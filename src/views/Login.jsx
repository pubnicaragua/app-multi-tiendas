...
const Login = () => {
  ...
  return (
    <div className="flex bg-gray-100 items-center min-h-screen w-full">
      <div className="w-full max-w-md p-8 bg-white shadow-lg rounded-lg">
      <h1 className="text-blue-900 font-extrabold text-2xl text-center mb-5">
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ¿No tienes cuenta? <a href="/auth/register" className="text-blue-600 hover:underline">Regístrate aquí</a>
        </p>
